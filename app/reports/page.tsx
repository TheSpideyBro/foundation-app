...
export default function ReportsPage() {
  ...
  const paidMemberRows = useMemo<PaidMemberRow[]>(() => {
    ...
    return Array.from(unique.values()).map((member) => {
      ...
      const isAdvance = payments.some((donation) => period === "monthly" && String(donation.date || "").slice(0, 7) < selectedMonth);
  ...
  }, [donations, period, selectedMonth, selectedYear, search, periodStart, periodEnd]);
