    ...
    <div className="min-h-screen bg-[#FDFCF9] flex flex-col lg:flex-row font-hind overflow-x-hidden">
      ...
      <header className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-white/95 backdrop-blur-xl border-b border-emerald-100/50 z-[40] px-5 flex items-center justify-between shadow-sm">
        <div className="flex items-center gap-2">
          ...
          <span className="text-md font-bold text-gray-900 font-tiro tracking-tight">দৌলখাঁড় পূর্বপাড়া হিলফুল ফুযুল ফাউন্ডেশন</span>
        </div>
        <div className="flex items-center gap-2">
          <button
      ...
      <aside className="hidden lg:flex flex-col w-72 bg-white border-r border-emerald-100/50 fixed h-full z-20 shadow-[4px_0_24px_rgba(0,0,0,0.02)]">
        <div className="p-8">
          <Link href="/dashboard" className="flex items-center gap-3 group">
            ...
            <div>
              <span className="text-xl font-bold text-gray-900 tracking-tight font-tiro">দৌলখাঁড় পূর্বপাড়া হিলফুল ফুযুল</span>
        ...
        <div className="h-full flex flex-col p-6 overflow-y-auto">
          <div className="flex items-center justify-between mb-10">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold text-gray-900 font-tiro">দৌলখাঁড় পূর্বপাড়া হিলফুল ফুযুল ফাউন্ডেশন</span>
            </div>
