-- Canonical monthly collection reporting.
-- Keeps one donations row per payment while allocating that payment across
-- covered months using each member's effective pledge for each month.
